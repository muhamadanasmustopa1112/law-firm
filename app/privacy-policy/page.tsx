  ...
  return (
    <div className="flex flex-col p-12 lg:p-24 bg-black/80 text-white">
      ...
      <div className="mt-5 mb-3">
        ...
        <p className="mb-1">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We collect and store information that
          users voluntarily provide, such as contact details and preferences.
          This information is used solely for the purpose of improving user
          experience and providing relevant content.
        </p>
      </div>
      <div className="mt-5 mb-3">
        ...
        <p className="mb-1">
          ...
          to safeguard user information. However, no method of transmission over
      ...
      <div className="mt-5 mb-3">
        ...
        <p className="mb-1">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This website uses cookies for a better
          user experience. Users can manage cookie preferences, but disabling
      ...
      <div className="mt-5 mb-3">
        ...
        <p className="mb-1">
          ...
          third-party sites. We are not responsible for the privacy practices or
      ...
      <div className="mt-5 mb-3">
        ...
        <p className="mb-1">
          ...
          terms and conditions and the privacy statement at any time. Users are
          encouraged to review these policies periodically.
        </p>
      </div>
      <div className="mt-5 mb-3">
        <p className="mb-1">
          By using this website, you acknowledge that you have read, understood,
          and agreed to these terms and conditions and the
          privacy&nbsp;statement.
        </p>
      </div>
    </div>
