    ...
    <div className="flex flex-col p-12 lg:p-24 bg-black/80 text-white">
      ...
      <div className="mt-5 mb-3">
        ...
        <p className="mb-1">
          ...
          informational purposes only. Reproduction, distribution, or
          modification of any content is prohibited without prior written
          consent.
        </p>
      </div>
      <div className="mt-5 mb-3">
        ...
        <p className="mb-1">
          ...
          accuracy and security of their information. Any use of the website
          that may disrupt its functionality or compromise security is strictly
          prohibited.
        </p>
      </div>
    </div>
