...
export default function Page() {
  return (
    <div className="py-4 sm:py-6 md:py-8 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48 relative z-10 bg-black/90 text-white">
      <div className="flex flex-col lg:flex-row justify-stretch gap-8">
        <div className="w-full flex flex-col gap-4">
          ...
          <p className="leading-[150%] mb-2 sm:mb-4 text-sm sm:text-base">
          ...
          <p
            className={`${sourceSansPro.className} text-center text-sm sm:text-base`}
          >
        ...
        <div className="w-full h-1 lg:w-1 lg:h-auto bg-white flex-shrink-0 my-4 lg:my-0"></div>
        <div className="w-full flex flex-col gap-4">
          <h1 className="text-3xl sm:text-4xl font-semibold mb-2 sm:mb-4">
            Contact Us | Collaborate for Progress
          </h1>
          <p
            className={`${sourceSansPro.className} leading-snug text-sm sm:text-base`}
          >
