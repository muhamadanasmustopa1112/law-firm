...
const Cars = () => {
    const cars = [
        {
            ...
            description: "4.0L Twin-Turbo V8 Gas 542 hp @ 6000 rpm 568 lb-ft @ 2000 rpm\n8-Speed Automatic",
        ...
        },
        {
            ...
            description: "6.0L Twin-Turbo W12 Gas 626 hp @ 6000 rpm 664 lb-ft @ 2000 rpm\n8-Speed Automatic",
            price: "Starts 14 Billion IDR*",
            information: "*Currently Only Available in Indonesia",
        ...
        },
        {
            ...
            description: "K4 blocks 338 kW / 5500-6500 rpm 550 Nm / 2000-5000 rpm\nAutomatic",
            price: "Starts 7 Billion IDR*",
            information: "*Currently Only Available in Indonesia",
        ...
        },
        {
            ...
            description: "4.0L Petrol Engine, 8 Cylinder 32 Valve DOHC 755 hp 800 Nm\nAutomatic",
            price: "Starts 21 Billion IDR*",
            information: "*Currently Only Available in Indonesia",
            image: "/img/cars/mclaren-765l-t-spider-special-mso-two-tone-paint-2023.png"
        },
    ...
    return (
        <>
            ...
            <h2 className='font-semibold text-4xl text-center relative before:content-[""] before:w-36 before:absolute before:-bottom-4 before:h-[2px] before:bg-white before:left-1/2 before:-translate-x-1/2'><span className='font-normal text-base'>Currently </span><br />Available Cars</h2>
            <div className="grid grid-cols-4 gap-6 mt-4">
                {cars.map(item => <AvailableCar item={item} key={item.name} />)}
            </div>
            <h2 className='mt-8 font-semibold text-4xl text-center relative before:content-[""] before:w-36 before:absolute before:-bottom-4 before:h-[2px] before:bg-white before:left-1/2 before:-translate-x-1/2'>Incoming</h2>
            <div className="flex flex-col items-center gap-6 mt-4">
                {incomingCars.map(item => <IncomingCar item={item} key={item.name} />)}
            </div>
            <Link href="#" className='self-center px-8 py-2 border border-white rounded-tl-[1.875rem] rounded-br-[1.875rem] w-fit'>See More</Link>
        </>
    )
}
